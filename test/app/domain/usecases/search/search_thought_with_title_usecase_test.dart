...
import 'package:teste_flutter_firebase/app/domain/usecases/search/search_thought_with_title_usecase.dart';

class MockThoughtRepository extends Mock implements ThoughtRepository {}

void main() {
  group('SearchThoughtWithTitleUsecase', () {
    late MockThoughtRepository mockThoughtRepository;
    late SearchThoughtWithTitleUsecase searchThoughtWithTitleUsecase;

    setUp(() {
      mockThoughtRepository = MockThoughtRepository();
      searchThoughtWithTitleUsecase =
          SearchThoughtWithTitleUsecase(mockThoughtRepository);
    });
    ...
    test('Deve retornar sucesso ao chamar o Usecase', () async {
      ...
      when(() => mockThoughtRepository.searchByTitle('title'))
          .thenAnswer((_) async => Right(thoughts));

      final result = await searchThoughtWithTitleUsecase(title: 'title');
